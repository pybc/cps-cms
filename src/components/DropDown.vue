<template>
  <div>
    <!-- DROPDOWN BUTTON -->
    <button
      class="flex flex-row drop-shadow border border-slate-300 hover:border-slate-400 py-2 px-2 w-44 outline-none focus:outline-none focus:border-blue-500 transition-colors rounded text-sm"
      @click="isOpen = !isOpen"
